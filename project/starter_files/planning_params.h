...
// Planning Constants
#define P_NUM_PATHS 5                  // TODO - Num of paths (goals) Student NOTE: add 2 offset paths on each side of center path
...
#define P_NUM_POINTS_IN_SPIRAL 4       // TODO - Num of points in the spiral Student NOTE: Is this for each point in the curvature? 2 points at 1/3 and 2/3 of path is standard
